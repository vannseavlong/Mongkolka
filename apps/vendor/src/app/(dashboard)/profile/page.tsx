...
import type { VendorCategory, VendorProfile } from "@/lib/types";
...
export default function ProfilePage() {
  const { data, loading, refetch } = useApiQuery<{ profile: VendorProfile }>("/vendor/api/profile");
  ...
  async function onSubmit(values: ProfileFormValues) {
    try {
      await api.patch("/vendor/api/profile", values);
