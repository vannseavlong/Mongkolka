...
/**
 * Split-screen auth chrome shared by the sign-in page — a branded panel on
 * the wide viewport, the actual form content on the right. Marketing copy is
 * passed in per page (sign-in only, in this app) rather than hardcoded here.
 */
  ...
  return (
    <main className="grid min-h-screen lg:grid-cols-2">
      <div className="relative hidden flex-col justify-between overflow-hidden bg-primary p-12 text-primary-foreground lg:flex">
        ...
        />
        <span className="relative text-lg font-semibold tracking-tight">Mongkolka Admin</span>
